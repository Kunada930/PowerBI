  ...
  return (
    <>
      ...
      <MainContent isDocked={isDocked}>
        ...
        {children}
        <ContentSection>
          <SectionTitle>Key Features of DARFO2 PowerBI Portal</SectionTitle>
          <FeatureGrid>
            <FeatureItem>
              <FeatureIcon icon={faLeaf} />
              <FeatureTitle>Crop Analytics</FeatureTitle>
              <FeatureDescription>
                Gain insights into crop production, yield, and market trends to optimize your farming strategies.
              </FeatureDescription>
            </FeatureItem>
            <FeatureItem>
              ...
              <FeatureDescription>
                Efficiently manage agricultural resources with data-driven tools and recommendations.
              </FeatureDescription>
            </FeatureItem>
            <FeatureItem>
              ...
              <FeatureDescription>
                Improve farm efficiency with metrics and benchmarks tailored to your agricultural needs.
              </FeatureDescription>
            </FeatureItem>
            <FeatureItem>
              ...
              <FeatureDescription>
                Stay ahead with up-to-date market data and price forecasts for informed decision-making.
              </FeatureDescription>
            </FeatureItem>
          </FeatureGrid>
        </ContentSection>
        <ContentSection>
          <SectionTitle>Why Choose DARFO2 PowerBI Portal?</SectionTitle>
          <p>
            The DARFO2 PowerBI Portal is your gateway to comprehensive agricultural data and analytics in Region 02. 
            Our platform empowers farmers, policymakers, and stakeholders with real-time insights and visualizations, 
            enabling data-driven decisions that enhance agricultural productivity and sustainability.
          </p>
          <p>
            With our user-friendly interface and powerful analytics tools, you can easily access and interpret 
            complex agricultural data, identify trends, and make informed choices that drive the growth and 
            resilience of the agricultural sector in our region.
          </p>
        </ContentSection>
      </MainContent>
      <Footer />
